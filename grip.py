...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [10, 60]
        self.__hsv_threshold_saturation = [0, 230]
    ...
    #Publishes details about the contour with the largest area
    def publish(self):
        contours = self.convex_hulls_output
        if len(contours) > 0:
            areas = []
            idx = 0
